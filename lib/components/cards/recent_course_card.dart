      ...
      children: [
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: course?.color[0].withOpacity(0.3), offset: Offset(0, 20), blurRadius: 30.0),
                  BoxShadow(color: course?.color[1].withOpacity(0.3), offset: Offset(0, 20), blurRadius: 30.0)
                ]
        ...
        Padding(
          ...
          child: Container(
              ...
              width: 60.0, height: 60.0, decoration: BoxDecoration(
              color: Colors.white,
